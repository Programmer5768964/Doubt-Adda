    ...
    <div>
      ...
      <div className="section-1" style={{background:`url(${(mode)?Sec1Light:Sec1Dark})`}}>
        <nav>
          ...
          <button onClick={()=>{setMode(!mode)}} style={{backgroundImage:`url(${(mode)?toggleLight:toggleDark})`,backgroundColor:`${(mode)?"#efefef":"#1e1e1e"}`}}></button>
        </nav>
        <div className="header-container">
          ...
          <div className="header-container-btn">
            <Link to="/askyourdoubt"><button>Ask your Doubt</button></Link>
